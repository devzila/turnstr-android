...
/**
 * Created by Nirmal on 6/14/2016.
 */
public class time_calculator {
    String Str_time_in_miles ;
    public String parseDate(String timeAtMiliseconds) {
        ...
        try {
            Date mDate = sdf.parse(timeAtMiliseconds);
            long timeInMilliseconds = mDate.getTime();
            Str_time_in_miles=String.valueOf(timeInMilliseconds);
        ...
        long dayagolong = Long.valueOf(Str_time_in_miles);
